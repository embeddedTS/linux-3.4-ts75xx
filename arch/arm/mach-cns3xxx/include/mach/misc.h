...
#ifndef MISC_GPIOA_PIN_ENABLE_REG
...
#define MISC_UART1_PINS						(MISC_UR_RXD1_PIN | MISC_UR_TXD1_PIN)
...
#define MISC_UR2_GPIOB_PINS									(MISC_UR_CTS2_PIN|MISC_UR_RXD2_PIN|MISC_UR_TXD2_PIN)
...
#ifndef HAL_MISC_ENABLE_UART0_PINS
...
#ifndef HAL_MISC_DISABLE_UART0_PINS
...
#ifndef HAL_MISC_ENABLE_UART1_PINS
...
#ifndef HAL_MISC_DISABLE_UART1_PINS
...
#ifndef HAL_MISC_ENABLE_UART2_PINS
#define HAL_MISC_ENABLE_UART2_PINS() \
{ \
    (MISC_GPIOA_PIN_ENABLE_REG) |= (MISC_UR2_GPIOA_PINS); \
    (MISC_GPIOB_PIN_ENABLE_REG) |= (MISC_UR2_GPIOB_PINS); \
    (MISC_IO_PIN_FUNC_SELECTION_REG) &= ~(0x1 << 2); \
}
#endif

#ifndef HAL_MISC_DISABLE_UART2_PINS
...
{ \
    (MISC_GPIOB_PIN_ENABLE_REG) |= (MISC_I2C_SCL_PIN | MISC_I2C_SDA_PIN); \
}
