...
#define INIT_PORT0_PHY rtl8367_init_phy();
#define INIT_PORT1_PHY
#define INIT_PORT2_PHY 

// configure mac0/mac1 register
#define INIT_PORT0_MAC rtl8367_init_mac(0); 
#define INIT_PORT1_MAC rtl8367_init_mac(1);
#define INIT_PORT2_MAC 

#define PORT0_LINK_DOWN disable_AN(0, 0);
#define PORT0_LINK_UP disable_AN(0, 1);

#define PORT1_LINK_DOWN disable_AN(0, 0);
#define PORT1_LINK_UP disable_AN(0, 1);

#define PORT2_LINK_DOWN 
#define PORT2_LINK_UP 

#define MODEL "RTL8367 Board"
