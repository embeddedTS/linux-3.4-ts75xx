...
#define GPIOA_REG_VALUE(offset) (*((volatile unsigned int *)(CNS3XXX_GPIOA_BASE_VIRT+offset)))
#define GPIOB_REG_VALUE(offset) (*((volatile unsigned int *)(CNS3XXX_GPIOB_BASE_VIRT+offset)))
...
#define IOPUD_REG MISC_REG_VALUE(0x34)
