...
//}
#define get_rx_ring_size(ring) ((RXRing *)ring)->ring_size
...
//}  
#define rx_index_next(ring) (((RXRing *)ring)->cur_index = ((((RXRing *)ring)->cur_index + 1) % ((RXRing *)ring)->ring_size))

//static inline void tx_index_next(TXRing *ring)
//{ 
//        ring->cur_index = ((ring->cur_index + 1) % ring->ring_size);
//}
#define tx_index_next(ring) (((TXRing *)ring)->cur_index = ((((TXRing *)ring)->cur_index + 1) % ((TXRing *)ring)->ring_size))
